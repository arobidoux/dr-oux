...
func assetsCssIndexCss() (*asset, error) {
	path := "F:\\go\\src\\DrMArio\\assets\\css\\index.css"
...
func assetsHtmlIndexHtml() (*asset, error) {
	path := "F:\\go\\src\\DrMArio\\assets\\html\\index.html"
...
func assetsImgFaviconIco() (*asset, error) {
	path := "F:\\go\\src\\DrMArio\\assets\\img\\favicon.ico"
...
func assetsJsIndexJs() (*asset, error) {
	path := "F:\\go\\src\\DrMArio\\assets\\js\\index.js"
